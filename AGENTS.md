...
- Use the TiXL debug bridge first for launch, project selection, graph inspection, output evaluation, and screenshots. The client is `tixl_blender_bridge/source/tixl_bridge.py`; the normal debug port is 9042.
